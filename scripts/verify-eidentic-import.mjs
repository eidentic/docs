...
const checks = [
  ...
  ['generated article coverage', summary.totalGeneratedArticles >= summary.totalOldDocs, `${summary.totalGeneratedArticles} generated`],
  ['generated missing docs', missingFromGenerated.length === 0, `${missingFromGenerated.length} missing`],
  ['search index coverage', summary.totalSearchEntries >= summary.totalOldDocs, `${summary.totalSearchEntries} indexed`],
